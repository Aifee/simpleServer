...
public sealed class Session
{
    ...
    private async void StartRecv()
    {
        while (true)
        {
            ...
            opcode = NetworkExtension.NetworkToHostOrder(opcode);
            try
            {
    ...
    private void Run(ushort opcode, byte[] messageBytes)
    {
        ...
        {
            messageBytes = ZipExtension.Decompress(messageBytes, opcodeAndFlagLength, messageBytes.Length - opcodeAndFlagLength);
            offset = 0;
        }
        else
        {
